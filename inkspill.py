...
def main():
    ...
    moveFont = pygame.font.SysFont(None, 36)
    ...
    while True: # main game loop
        ...
        drawLifeMeter(life)
        drawPalettes()
        drawMoveCounter(moveCount, moveFont)
...
def drawMoveCounter(moveCount, font):
    textSurf = font.render(f"Moves: {moveCount}", True, BLACK, bgColor)
    DISPLAYSURF.blit(textSurf, (20, 0))
